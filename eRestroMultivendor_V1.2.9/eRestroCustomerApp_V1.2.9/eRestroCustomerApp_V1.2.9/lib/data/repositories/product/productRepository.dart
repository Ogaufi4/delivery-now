...
import 'package:project/data/repositories/product/productRemoteDataSource.dart';
...
class ProductRepository {
  ...
  Future<List<ProductDetails>> getOfflineCartData(String? latitude, String? longitude, String? cityId, String? productVariantIds) async {
    try {
