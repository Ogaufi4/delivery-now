...
class AuthLocalDataSource {
  bool? checkIsAuth() {
    return Hive.box(authBox).get(isLoginKey, defaultValue: false) ?? false;
  }
  ...
  String? getType() {
    return Hive.box(authBox).get(typeKey, defaultValue: "");
  }
  ...
  static Future<void> setJwtTocken(String? tocken) async {
    Hive.box(authBox).put(jwtTokenKey, tocken);
  }
  ...
  Future<void> setType(String? type) async {
    Hive.box(authBox).put(typeKey, type);
  }
  ...
  Future<void> setNoOfRatings(String? noOfRatings) async {
