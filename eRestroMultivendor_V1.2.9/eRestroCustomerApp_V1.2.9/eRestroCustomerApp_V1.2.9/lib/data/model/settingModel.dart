...
class Data {
  ...
  Data.fromJson(Map<String, dynamic> json) {
    logo =
        json['logo'] == null
            ? List<String>.from([])
            : (json['logo'] as List).map((e) => e.toString()).toList();
    privacyPolicy =
        json['privacy_policy'] == null
            ...
            : (json['privacy_policy'] as List)
                ...
                .toList();
    termsConditions =
        json['terms_conditions'] == null
            ? List<String>.from([])
            : (json['terms_conditions'] as List)
                .map((e) => e.toString())
                .toList();
    fcmServerKey =
        json['fcm_server_key'] == null
            ? List<String>.from([])
            : (json['fcm_server_key'] as List)
                .map((e) => e.toString())
                .toList();
    contactUs =
        json['contact_us'] == null
            ? List<String>.from([])
            : (json['contact_us'] as List).map((e) => e.toString()).toList();
    aboutUs =
        json['about_us'] == null
            ? List<String>.from([])
            : (json['about_us'] as List).map((e) => e.toString()).toList();
    currency =
        json['currency'] == null
            ? List<String>.from([])
            : (json['currency'] as List).map((e) => e.toString()).toList();
