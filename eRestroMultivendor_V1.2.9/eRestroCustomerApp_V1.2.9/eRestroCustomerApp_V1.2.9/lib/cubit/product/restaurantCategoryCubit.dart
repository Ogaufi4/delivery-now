...
class RestaurantCategoryCubit extends Cubit<RestaurantCategoryState> {
  ...
  Future<List<CuisineModel>> fetchCategoryFromDb(BuildContext context, String restSlug) async {
    List<CuisineModel> categorylist = [];
    Map<String, String> body = {"partner_slug": restSlug};

    final response = await http.post(Uri.parse(Api.getCategoriesUrl), body: body, headers: Api.getHeaders());
