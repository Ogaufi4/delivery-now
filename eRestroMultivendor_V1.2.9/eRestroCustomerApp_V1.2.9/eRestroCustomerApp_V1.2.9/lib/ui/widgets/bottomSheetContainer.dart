                                      ...
                                      children: [
                                        Row(children: [
                                          ...
                                          widget.productDetailsModel.isSpicy == "1"
                                              ? DesignConfig().spicyWidget(widget.width)
                                            ...
                                            builder: (context, favoriteProductState) {
                                                    ...
                                                    if (state is UpdateProductFavoriteStatusInProgress) {
                                                      return Container(
                                                          ...
                                                          decoration: DesignConfig.boxDecorationCircle(
                                                              Theme.of(context).colorScheme.surface, Theme.of(context).colorScheme.surface, 50.0),
                                                    ...
                                                    return InkWell(
                                                        ...
                                                        child: Container(
                                                            ...
                                                            child: isProductFavorite
                                                                ...
                                                                : SvgPicture.asset(DesignConfig.setSvgPath("wishlist"), width: 20.0, height: 20)));
                                                  },
                                                );
                                              }
                                              ...
                                              return InkWell(
                                                  ...
                                                  child: Container(
                                                      ...
                                                      child: SvgPicture.asset(DesignConfig.setSvgPath("wishlist"), width: 20.0, height: 20)));
                                            });
                                      }),
                                      const Spacer(),
                                      Container(
                                        ...
                                        decoration: DesignConfig.boxDecorationContainerBorder(
                                            Theme.of(context).colorScheme.primary, Theme.of(context).colorScheme.primary.withValues(alpha: 0.10), 5.0),
                                              ...
                                              Expanded(
                                                child: Padding(
                                                  ...
                                                  child: InkWell(
                                                      onTap: () {
                                                        setState(() {
                                                          if (qty >= int.parse(widget.productDetailsModel.totalAllowedQuantity!)) {
