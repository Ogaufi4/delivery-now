  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider<UpdateRestaurantFavoriteStatusCubit>(
      ...
      child: Builder(builder: (context) {
        return InkWell(
          onTap: () {
            Navigator.of(context).pushNamed(Routes.restaurantDetail, arguments: {'restaurant': restaurant});
          },
          child: Container(
                      ...
                      children: [
                        ClipRRect(
                            ...
                            child: ColorFiltered(
                              ...
                              child: DesignConfig.imageWidgets(restaurant.partnerProfile!, height! / 8.0, width!, "2"),
                            )),
                                  ...
                                  builder: (context, favoriteRestaurantState) {
                                    if (favoriteRestaurantState is FavoriteRestaurantsFetchSuccess) {
                                      ...
                                      bool isRestaurantFavorite =
                                          context.read<FavoriteRestaurantsCubit>().isRestaurantFavorite(restaurant.partnerId!);
                                        ...
                                        builder: (context, state) {
                                          if (state is UpdateRestaurantFavoriteStatusInProgress) {
                                            return Container(
                                              width: 30.0,
                                              height: 30,
                                              margin: const EdgeInsetsDirectional.only(end: 5.0, top: 5),
                                              child: ClipOval(
                                          ...
                                          return Padding(
                                            ...
                                            child: InkWell(
                                                onTap: () {
                                                  ...
                                                  print(favoriteRestaurantState.toString());
                                                  if (state is UpdateRestaurantFavoriteStatusInProgress) {
                                                    return;
                                                  }
                    ...
                    child: Padding(
                      ...
                      child: Column(mainAxisAlignment: MainAxisAlignment.start, crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        Row(
                          ...
                          children: [
                            double.parse(restaurant.partnerRating!).toStringAsFixed(1) == "0.0"
                                ? const SizedBox()
                                : Row(
                                    mainAxisAlignment: MainAxisAlignment.start,
                                    children: [
                                      ...
                                      Text(double.parse(restaurant.partnerRating!).toStringAsFixed(1),
                                          ...
                                          style: TextStyle(
                                              color: Theme.of(context).colorScheme.onSecondary, fontSize: 14, fontWeight: FontWeight.normal)),
                                    ],
                                  ),
                            double.parse(restaurant.partnerRating!).toStringAsFixed(1) == "0.0" ? const SizedBox() : SizedBox(width: width! / 60.0),
                            Row(
                              mainAxisAlignment: MainAxisAlignment.start,
                              children: [
                                SvgPicture.asset(DesignConfig.setSvgPath("time_filled"), fit: BoxFit.scaleDown, width: 7.0, height: 12.3),
                                const SizedBox(width: 5.0),
                                Text(
