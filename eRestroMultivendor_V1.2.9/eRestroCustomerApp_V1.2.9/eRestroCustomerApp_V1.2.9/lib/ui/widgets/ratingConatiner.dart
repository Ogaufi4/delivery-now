...
class RatingConatiner extends StatefulWidget {
  ...
  const RatingConatiner({Key? key, required this.index, this.width, this.height, this.productId}) : super(key: key);
          ...
          children: [
            InkWell(
                ...
                child: Align(
                    ...
                    child: SizedBox(
                      width: reviewPhotos.isEmpty ? widget.width! / 1.16 : widget.width! / 4.0,
                      height: widget.height! / 10.0,
                      child: DottedBorder(
    ...
    return Column(
      children: [
        ...
        ratingList.isEmpty
            ...
            : Text(ratingList[selectedIndex!].title.toString(),
                textAlign: TextAlign.center,
