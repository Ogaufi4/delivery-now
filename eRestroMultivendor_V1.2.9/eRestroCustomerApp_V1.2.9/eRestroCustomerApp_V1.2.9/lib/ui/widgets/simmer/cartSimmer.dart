                    ...
                    child: SingleChildScrollView(
                      child: Column(
                        ...
                        children: [
                          Padding(
                            ...
                            child: Row(
                              children: [
                                ...
                                Container(width: 15, height: 15, color: shimmerContentColor),
                              ],
                            ),
                          ),
                          Padding(
                          ...
                          Padding(
                            padding:
                                EdgeInsetsDirectional.only(start: width! / 40.0, end: width! / 40.0, top: height! / 50.0, bottom: height! / 20.0),
                            child: Row(children: [
                              Container(
                                width: width! / 4.0,
                                height: 8.0,
                            ...
                            child: ListView.builder(
                                ...
                                itemBuilder: (BuildContext context, i) {
                                  return Container(
                                    ...
                                    margin: EdgeInsetsDirectional.only(start: width! / 60.0, end: width! / 60.0), width: width! / 4.0,
