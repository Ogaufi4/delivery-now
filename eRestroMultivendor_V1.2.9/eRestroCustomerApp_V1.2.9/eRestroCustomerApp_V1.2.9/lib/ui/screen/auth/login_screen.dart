...
import 'package:project/ui/screen/auth/otp_verify_screen.dart';
...
import 'package:project/ui/widgets/buttomWithImageContainer.dart';
...
class LoginScreen extends StatefulWidget {
  ...
  static Route<LoginScreen> route(RouteSettings routeSettings) {
    ...
    return CupertinoPageRoute(
      builder: (_) => LoginScreen(from: arguments['from'] as String),
    );
  }
}
...
class LoginScreenState extends State<LoginScreen> {
  ...
  bool obscure = true,
      status = false,
      iAccept = Platform.isAndroid ? false : true,
      skipStatus = false,
      loginStatus = false;
                ...
                Platform.isIOS
                    ? SizedBox(
                      ...
                      child: ButtonImageContainer(
                        ...
                        onPressed: () {
                          if (iAccept == true) {
                            context.read<ReferAndEarnCubit>().fetchReferAndEarn(
                              referCode,
                            );
                            status = false;
                  ...
                  child: Row(
                    ...
                    children: [
                      Theme(
                        data: Theme.of(
                          context,
                        ).copyWith(unselectedWidgetColor: greayLightColor),
                        child: Checkbox(
                          value: iAccept,
