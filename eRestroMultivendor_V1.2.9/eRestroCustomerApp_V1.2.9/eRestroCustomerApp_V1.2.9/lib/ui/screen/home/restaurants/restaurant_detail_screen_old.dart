                                    ...
                                    child: Container(
                                      ...
                                      decoration: DesignConfig.boxDecorationContainer(
                                          constraints.scrollOffset >= 350
                                              ? Theme.of(context).colorScheme.onSurface
                                              : greayLightColor.withValues(alpha: 0.70),
                                          5.0),
                                      child: Icon(
                                        Icons.arrow_back,
                                                                ...
                                                                ? SvgPicture.asset(DesignConfig.setSvgPath("wishlist-filled"),
                                                                    ...
                                                                    colorFilter: ColorFilter.mode(
                                                                        constraints.scrollOffset >= 350
                                                                            ...
                                                                            : Theme.of(context).colorScheme.onSurface,
                                                                        BlendMode.srcIn))
                                                                : SvgPicture.asset(DesignConfig.setSvgPath("wishlist"),
                                                                    fit: BoxFit.scaleDown,
                                                                    width: 18.0,
                                                                    height: 18.3,
                                                                    colorFilter: ColorFilter.mode(
                                            ...
                                            child: ShaderMask(
                                                shaderCallback: (Rect bounds) {
                                                  return LinearGradient(
                                                    ...
                                                    colors: [
                                                      Theme.of(context).colorScheme.onSecondary.withValues(alpha: 0.25),
                                                      Theme.of(context).colorScheme.onSecondary.withValues(alpha: 0.25)
                                                    ],
                                                  ).createShader(bounds);
                                                },
                                                ...
                                                child: ColorFiltered(
                                                  colorFilter: widget.restaurant!.isRestroOpen == "1"
                                                      ? ColorFilter.mode(
                                                          Theme.of(context).colorScheme.onSecondary.withValues(alpha: 0.70),
                                                          BlendMode.multiply,
                                                        )
