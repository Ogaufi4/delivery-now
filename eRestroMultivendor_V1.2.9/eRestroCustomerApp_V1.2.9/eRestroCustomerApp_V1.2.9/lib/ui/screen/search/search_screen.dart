...
import 'package:project/ui/widgets/searchContainer.dart';
import 'package:project/ui/widgets/simmer/notificationSimmer.dart';
                  ...
                  : ListView.builder(
                      ...
                      itemBuilder: (BuildContext context, index) {
                        return hasMore && searchList.isEmpty && index == (searchList.length - 1)
                            ...
                            : SearchContainer(restaurant: searchList[index], height: height!, width: width!, searchText: searchController.text);
                      }));
        });
  }
    ...
    return Container(
        ...
        child: TextField(
          ...
          decoration: InputDecoration(
            ...
            prefixIcon: InkWell(onTap: () {}, child: const Icon(Icons.search, color: lightFont)),
