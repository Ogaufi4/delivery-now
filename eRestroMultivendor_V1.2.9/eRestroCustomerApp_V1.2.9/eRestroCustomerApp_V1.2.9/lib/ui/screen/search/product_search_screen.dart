...
import 'package:project/cubit/home/search/productSearchCubit.dart';
  ...
  static Route<dynamic> route(RouteSettings routeSettings) {
    ...
    return CupertinoPageRoute(
        builder: (_) => BlocProvider<ProductSearchCubit>(
              ...
              child: ProductSearchScreen(partnerId: arguments['partnerId'] as String, partnerName: arguments['partnerName'] as String),
            ));
  }
}
...
class ProductSearchScreenState extends State<ProductSearchScreen> {
                            ...
                            children: [
                              speech.isListening
                                  ? Text(
                                      ...
                                      style: const TextStyle(fontSize: 16, color: greayLightColor, fontWeight: FontWeight.bold),
                                    )
                                ...
                                child: Center(
                                    child: speech.isListening
                                        ...
                                        : Text(
                                            ...
                                            style: TextStyle(
                                                fontSize: 12, color: Theme.of(context).colorScheme.onSecondary, fontWeight: FontWeight.bold),
                                          )),
                              ),
                            ],
                          ),
  ...
  void errorListener(SpeechRecognitionError error) {
    ...
    if (mounted) {
      setState(() {
        UiUtils.setSnackBar(UiUtils.getTranslatedLabel(context, searchLabel), error.errorMsg, context, false, type: "2");
      });
    }
  }
              ...
              child: InkWell(
                  ...
                  child: Container(
                      ...
                      decoration: DesignConfig.boxDecorationContainer(
                          statusFoodType == "" ? Theme.of(context).colorScheme.primary : Theme.of(context).colorScheme.onSurface, 15.0),
                                        ...
                                        if (dataItem.availableTime == "1") {
                                          if (check == true) {
                                            bottomModelSheetShow(context
                                                .read<GetCartCubit>()
                                                .getProductDetailsData(productSearchList[i].id!, productSearchList[i])[0]);
                                          } else {
                                            showDialog(
                                                context: context,
                                          ...
                                          bottomModelSheetShow(
                                              context.read<GetCartCubit>().getProductDetailsData(productSearchList[i].id!, productSearchList[i])[0]);
                                        }
                                      } else {
                                        showDialog(
      ...
      child: _connectionStatus == connectivityCheck
          ...
          : Scaffold(
              appBar: DesignConfig.appBar(
                  ...
                  widget.partnerName,
                  PreferredSize(
                    preferredSize: Size(width!, height! / 6.0),
                    child: Column(
