          ...
          return GridView.count(
              ...
              children: List.generate(filterList.length, (index) {
                ...
                if (filterList[index].variants![0].specialPrice! != "0") {
                  off = (double.parse(filterList[index].variants![0].price!) - double.parse(filterList[index].variants![0].specialPrice!)).toDouble();
                    ...
                    : GestureDetector(
                        onTap: () {
                          if (filterList[index].partnerDetails![0].isRestroOpen == "1") {
                            bottomModelSheetShow(context.read<GetCartCubit>().getProductDetailsData(filterList[index].id!, filterList[index])[0]);
                          } else {
      ...
      child: _connectionStatus == connectivityCheck
          ...
          : Scaffold(
              appBar: DesignConfig.appBar(
                  context, width, UiUtils.getTranslatedLabel(context, filterLabel), const PreferredSize(preferredSize: Size.zero, child: SizedBox())),
              body: Container(
                height: height!,
