...
import 'package:project/ui/widgets/simmer/categoryVerticallySimmer.dart';
...
class FilterScreen extends StatefulWidget {
  ...
  static Route<dynamic> route(RouteSettings routeSettings) {
    ...
    return CupertinoPageRoute(builder: (_) => FilterScreen(filterBy: arguments['filterBy'] as String));
  }
}
              ...
              child: InkWell(
                  ...
                  child: Container(
                      ...
                      decoration: DesignConfig.boxDecorationContainer(
                          statusFoodType == "3" ? Theme.of(context).colorScheme.primary : Theme.of(context).colorScheme.onSurface, 15.0),
          ...
          Expanded(
              child: InkWell(
                  ...
                  child: Container(
                      ...
                      padding: EdgeInsetsDirectional.only(top: height! / 55.0, bottom: height! / 55.0, start: width! / 99.0, end: width! / 99.0),
                      decoration: DesignConfig.boxDecorationContainer(
                          statusFoodType == "1" ? Theme.of(context).colorScheme.primary : Theme.of(context).colorScheme.onSurface, 15.0),
          ...
          Expanded(
              child: InkWell(
                  ...
                  child: Container(
                      ...
                      padding: EdgeInsetsDirectional.only(top: height! / 55.0, bottom: height! / 55.0, start: width! / 99.0, end: width! / 99.0),
                      decoration: DesignConfig.boxDecorationContainer(
                          statusFoodType == "2" ? Theme.of(context).colorScheme.primary : Theme.of(context).colorScheme.onSurface, 15.0),
          ...
          Expanded(
              child: InkWell(
                  ...
                  child: Container(
                      ...
                      decoration: DesignConfig.boxDecorationContainer(
                          statusRating == "1" ? Theme.of(context).colorScheme.primary : textFieldBackground, 10.0),
                      child: Row(
                        ...
                        children: [
                          SvgPicture.asset(DesignConfig.setSvgPath("restaurant_rating"),
                              ...
                              colorFilter: ColorFilter.mode(
                                  statusRating == "1" ? Theme.of(context).colorScheme.onSurface : Theme.of(context).colorScheme.primary,
                                  BlendMode.srcIn)),
          ...
          Expanded(
              child: InkWell(
                  ...
                  child: Container(
                      ...
                      decoration: DesignConfig.boxDecorationContainer(
                          statusRating == "2" ? Theme.of(context).colorScheme.primary : textFieldBackground, 10.0),
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          SvgPicture.asset(DesignConfig.setSvgPath("restaurant_rating"),
                              ...
                              height: 11.5,
                              colorFilter: ColorFilter.mode(
                                  statusRating == "2" ? Theme.of(context).colorScheme.onSurface : Theme.of(context).colorScheme.primary,
                                  BlendMode.srcIn)),
                          SizedBox(width: width! / 99.0),
                          Text("2",
                              textAlign: TextAlign.center,
          ...
          Expanded(
              child: InkWell(
                  ...
                  child: Container(
                      ...
                      decoration: DesignConfig.boxDecorationContainer(
                          statusRating == "3" ? Theme.of(context).colorScheme.primary : textFieldBackground, 10.0),
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          SvgPicture.asset(DesignConfig.setSvgPath("restaurant_rating"),
                              ...
                              height: 11.5,
                              colorFilter: ColorFilter.mode(
                                  statusRating == "3" ? Theme.of(context).colorScheme.onSurface : Theme.of(context).colorScheme.primary,
                                  BlendMode.srcIn)),
                          SizedBox(width: width! / 99.0),
                          Text("3",
                              textAlign: TextAlign.center,
          ...
          Expanded(
              child: InkWell(
                  ...
                  child: Container(
                      ...
                      decoration: DesignConfig.boxDecorationContainer(
                          statusRating == "4" ? Theme.of(context).colorScheme.primary : textFieldBackground, 10.0),
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          SvgPicture.asset(DesignConfig.setSvgPath("restaurant_rating"),
                              ...
                              height: 11.5,
                              colorFilter: ColorFilter.mode(
                                  statusRating == "4" ? Theme.of(context).colorScheme.onSurface : Theme.of(context).colorScheme.primary,
                                  BlendMode.srcIn)),
                          SizedBox(width: width! / 99.0),
                          Text("4",
                              textAlign: TextAlign.center,
          ...
          Expanded(
              child: InkWell(
                  ...
                  child: Container(
                      ...
                      decoration: DesignConfig.boxDecorationContainer(
                          statusRating == "5" ? Theme.of(context).colorScheme.primary : textFieldBackground, 10.0),
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.center,
                        ...
                        children: [
                          SvgPicture.asset(DesignConfig.setSvgPath("restaurant_rating"),
                              ...
                              height: 11.5,
                              colorFilter: ColorFilter.mode(
                                  statusRating == "5" ? Theme.of(context).colorScheme.onSurface : Theme.of(context).colorScheme.primary,
                                  BlendMode.srcIn)),
                          SizedBox(width: width! / 99.0),
                          Text("5",
                              textAlign: TextAlign.center,
  ...
  Widget build(BuildContext context) {
    ...
    return AnnotatedRegion<SystemUiOverlayStyle>(
      ...
      child: _connectionStatus == connectivityCheck
          ...
          : Scaffold(
              appBar: DesignConfig.appBar(context, width!, UiUtils.getTranslatedLabel(context, filterLabel),
              ...
              bottomNavigationBar: Row(
                ...
                children: [
                  ...
                  Expanded(
                    ...
                    textColor: white,
                    onPressed: () {
                      Navigator.of(context).pushNamed(Routes.filterDetail, arguments: {
              ...
              body: Container(
                ...
                child: SingleChildScrollView(
                  child: Column(mainAxisAlignment: MainAxisAlignment.start, crossAxisAlignment: CrossAxisAlignment.start, children: [
                    ...
                    Text(UiUtils.getTranslatedLabel(context, costLabel),
                        style: TextStyle(fontSize: 14.0, color: Theme.of(context).colorScheme.onSecondary, fontWeight: FontWeight.w500)),
                    Padding(
