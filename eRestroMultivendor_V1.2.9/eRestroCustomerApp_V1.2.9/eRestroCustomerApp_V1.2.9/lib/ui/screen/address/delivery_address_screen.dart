...
import 'package:project/cubit/address/deleteAddressCubit.dart';
                      ...
                      child: Builder(builder: (context) {
                        return GestureDetector(
                          ...
                          child: Container(
                            ...
                            padding:
                                EdgeInsetsDirectional.only(top: height! / 40.0, bottom: height! / 40.0, start: width! / 20.0, end: width! / 40.0),
                                  ...
                                  BlocConsumer<DeleteAddressCubit, DeleteAddressState>(
                                      ...
                                      listener: (context, state) {
                                        if (state is DeleteAddressSuccess) {
                                          ...
                                          UiUtils.setSnackBar(
                                              UiUtils.getTranslatedLabel(context, addressLabel), StringsRes.deleteSuccessFully, context, false,
                                              type: "1");
                                        }
                                      },
                                      builder: (context, state) {
                                        return SmallButtonContainer(
                                          ...
                                          onTap: () {
                                            if (addressList.length > 1) {
                                              ...
                                              UiUtils.setSnackBar(
                                                  UiUtils.getTranslatedLabel(context, addressLabel), StringsRes.addressChange, context, false,
                                                  type: "2");
                                            } else {
                                              UiUtils.setSnackBar(
                                                  UiUtils.getTranslatedLabel(context, addressLabel), StringsRes.addressOne, context, false,
                                                  type: "2");
                                            }
                                          },
                                        );
