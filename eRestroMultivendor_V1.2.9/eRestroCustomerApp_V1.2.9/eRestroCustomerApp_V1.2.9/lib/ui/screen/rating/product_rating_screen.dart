...
import 'package:project/cubit/rating/setOrderRatingCubit.dart';
import 'package:project/cubit/rating/setProductRatingCubit.dart';
import 'package:project/data/model/orderModel.dart';
import 'package:project/data/model/rattingModel.dart';
...
import 'package:project/ui/widgets/ratingConatiner.dart';
import 'package:project/ui/widgets/simmer/orderDetailSimmer.dart';
        ...
        children: List.generate(ratingList.length, (m) {
          return Padding(
            ...
            child: InkWell(
                ...
                child: SvgPicture.asset(DesignConfig.setSvgPath(ratingList[m].image!), height: selectedIndex == m ? 60.0 : 40)),
          );
        }));
  }
