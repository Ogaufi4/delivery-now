...
import 'package:project/cubit/rating/getRestaurantRatingCubit.dart';
  ...
  Widget getRestaurantRating() {
    return BlocConsumer<GetRestaurantRatingCubit, GetRestaurantRatingState>(
        ...
        builder: (context, state) {
          ...
          return restaurantRatingList.isEmpty
              ? Container(
                  alignment: Alignment.center,
                  height: height!,
                  child: Column(
              ...
              : ListView.builder(
                  ...
                  itemCount: restaurantRatingList.length,
                  padding: EdgeInsetsDirectional.zero,
                  itemBuilder: (BuildContext context, index) {
                    print(restaurantRatingList[index].images!.length);
                    var inputFormat = DateFormat('yyyy-MM-dd HH:mm:ss');

                    var inputDate = inputFormat.parse(restaurantRatingList[index].dateAdded!.toString());
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: Column(mainAxisAlignment: MainAxisAlignment.start, crossAxisAlignment: CrossAxisAlignment.start, children: [
                                    ...
                                    restaurantRatingList[index].comment!.isNotEmpty
                                        ? Text(restaurantRatingList[index].comment!,
                                            textAlign: TextAlign.start,
                                            style: TextStyle(
                                                color: Theme.of(context).colorScheme.onSecondary,
                                                fontSize: 12,
                                    ...
                                    restaurantRatingList[index].images!.isEmpty
                                        ? const SizedBox()
                                        : Container(
                                            height: 80.0,
                                                ...
                                                itemBuilder: (context, i) {
                                                  return Padding(
                                                    ...
                                                    child: ClipRRect(
                                                        ...
                                                        child: DesignConfig.imageWidgets(restaurantRatingList[index].images![i], 80, 80, "2")),
                                                  );
                                                })),
                                    context.read<AuthCubit>().getId() == restaurantRatingList[index].userId!
          ...
          : Scaffold(
              ...
              body: Container(
                ...
                child: RefreshIndicator(
                    ...
                    child: SingleChildScrollView(physics: const AlwaysScrollableScrollPhysics(), child: getRestaurantRating())),
              ),
            ),
    );
  }
