...
import 'package:project/cubit/rating/getRiderRatingCubit.dart';
            ...
            return Center(
              child: Column(mainAxisAlignment: MainAxisAlignment.center, crossAxisAlignment: CrossAxisAlignment.center, children: [
                ...
                Text(UiUtils.getTranslatedLabel(context, noReviewFoundLabel),
                    ...
                    style: TextStyle(color: Theme.of(context).colorScheme.onSecondary, fontSize: 28 )),
                const SizedBox(height: 5.0),
                Text(UiUtils.getTranslatedLabel(context, noReviewSubTitleLabel),
                    textAlign: TextAlign.center,
                    maxLines: 2,
                    style: const TextStyle(color: lightFont, fontSize: 14 )),
              ]),
            );
          }
          ...
          return SizedBox(
              ...
              child: ListView.builder(
                  ...
                  itemBuilder: (BuildContext context, index) {
                    ...
                    var inputDate = inputFormat.parse(riderRatingList[index].dateAdded!.toString());
