...
import 'package:project/ui/screen/rating/thank_you_for_review_screen.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return AnnotatedRegion<SystemUiOverlayStyle>(
        ...
        child: _connectionStatus == connectivityCheck
            ...
            : Scaffold(
                appBar: DesignConfig.appBar(context, width, UiUtils.getTranslatedLabel(context, reviewLabel),
                ...
                bottomNavigationBar: BlocConsumer<SetRiderRatingCubit, SetRiderRatingState>(
                    ...
                    builder: (context, state) {
                      return ButtonContainer(
                        ...
                        bottom: height! / 55.0,
                        top: 0,
                        status: (state is SetRiderRatingProgress) ? true : false,
                        borderColor: Theme.of(context).colorScheme.secondary,
                        textColor: white,
                        onPressed: () async {
                          context.read<SetRiderRatingCubit>().setRiderRating(
                              context.read<AuthCubit>().getId(), widget.riderId, rating.toString(), commentController.text, widget.id!);
                        },
                      );
                    }),
                body: Container(
                    margin: EdgeInsetsDirectional.only(top: height! / 80.0),
                    padding: EdgeInsetsDirectional.only(start: width! / 20.0, end: width! / 20.0, top: height! / 40.0),
                    ...
                    child: SingleChildScrollView(
                      child: Column(mainAxisAlignment: MainAxisAlignment.start, crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        Padding(
                          ...
                          child: Divider(
                            color: textFieldBorder.withValues(alpha: 0.50),
                            height: 0.0,
                          ),
                        ),
                        Row(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Text(widget.riderName ?? "",
                                          textAlign: TextAlign.start,
                                          style:
                                              TextStyle(color: Theme.of(context).colorScheme.onSecondary, fontSize: 12, fontWeight: FontWeight.w500),
                                          maxLines: 2),
                                      Row(
                                        children: [
                                          ...
                                          Text(widget.riderRating ?? "" " ( ${widget.riderNoOfRating ?? ""} Review )",
                                              textAlign: TextAlign.start,
                                              style: TextStyle(
                                                  color: Theme.of(context).colorScheme.onSecondary, fontSize: 10, fontWeight: FontWeight.w500)),
                                        ],
                                      ),
