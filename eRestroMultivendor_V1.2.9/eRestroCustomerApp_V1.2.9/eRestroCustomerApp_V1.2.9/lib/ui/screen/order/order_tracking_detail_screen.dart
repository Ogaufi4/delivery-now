...
class _OrderTrackingDetailScreenState extends State<OrderTrackingDetailScreen> {
                                        ...
                                        Row(
                                          children: [
                                            Container(
                                              ...
                                              height: 36.0,
                                              width: 36,
                                              decoration: DesignConfig.boxDecorationContainer(orderTrackingCardRedColor.withValues(alpha: 0.30), 5.0),
  ...
  _getPolylineBetweenRestaurantToCustomer() async {
    ...
    PolylineId polylineId = PolylineId(widget.orderAddress!); 
    Polyline polyline = Polyline(
        polylineId: polylineId,
        visible: true,
        points: mainroute,
