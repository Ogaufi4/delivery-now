                                                  ...
                                                  Container(
                                                      ...
                                                      decoration: DesignConfig.boxDecorationContainer(
                                                          orderList[0].status![index][0] == pendingKey
                                                              ? orderTrackingCardYellowColor.withValues(alpha: 0.30)
                                                              : orderList[0].status![index][0] == confirmedKey
                                                                  ? orderTrackingCardGreenColor.withValues(alpha: 0.30)
                                                                  : orderList[0].status![index][0] == preparingKey
                                                                      ? orderTrackingCardRedColor.withValues(alpha: 0.30)
                                                                      : orderList[0].status![index][0] == outForDeliveryKey
                                                                          ? orderTrackingCardPeachColor.withValues(alpha: 0.30)
                                                                          : orderTrackingCardYellowColor.withValues(alpha: 0.30),
                                                          5.0),
