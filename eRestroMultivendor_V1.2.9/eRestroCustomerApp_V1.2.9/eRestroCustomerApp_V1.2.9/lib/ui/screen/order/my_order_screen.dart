...
class MyOrderScreenState extends State<MyOrderScreen> {
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          enableList
              ? Column(
                  children: List.generate(reasonList.length, (position) {
                  return InkWell(
                    onTap: () {
                                      ...
                                      child: InkWell(
                                          ...
                                          child: Container(
                                              ...
                                              decoration: DesignConfig.boxDecorationContainerBorder(
                                                  Theme.of(context).colorScheme.onSecondary, Theme.of(context).colorScheme.onSurface, 100.0),
                              ...
                              Expanded(
                                  ...
                                  child: InkWell(
                                      ...
                                      child: Container(
                                          ...
                                          decoration: DesignConfig.boxDecorationContainerBorder(
                                              Theme.of(context).colorScheme.secondary, Theme.of(context).colorScheme.onSurface, 100.0),
                                          child: Text(UiUtils.getTranslatedLabel(context, noLabel),
                                              textAlign: TextAlign.center,
                                              maxLines: 1,
                                              style: TextStyle(
                                                  color: Theme.of(context).colorScheme.onSecondary, fontSize: 16, fontWeight: FontWeight.w500))))),
                              Expanded(
                                  flex: 1,
                                  child: InkWell(
                                      onTap: () {
                                        if (reason == "" || reason!.isEmpty) {
                                          ...
                                          context
                                              ...
                                              .getUpdateOrderStatus(status: status, orderId: orderId, reason: reason);
                                        }
                                      },
                                      child: Container(
                                          margin: EdgeInsetsDirectional.only(top: height! / 99.0),
  ...
  bool isStatusAfter(String currentStatus, String compareStatus) {
    ...
    List<String> statusOrder = [pendingKey, confirmedKey, preparingKey, readyForPickupKey, outForDeliveryKey];
                            ...
                            : BlocProvider(
                                ...
                                child: Builder(builder: (context) {
                                  return GestureDetector(
                                    ...
                                    child: Container(
                                        padding: EdgeInsetsDirectional.only(start: 0.0, top: 0, end: 0, bottom: height! / 80.0),
                                        ...
                                        child: Column(
                                          children: [
                                                ...
                                                children: [
                                                  ClipRRect(
                                                      ...
                                                      child: DesignConfig.imageWidgets(
                                                          orderList[index].orderItems![0].partnerDetails![0].partnerProfile!, 50.0, 50.0, "2")),
                                                  Expanded(
                                                    child: Padding(
                                                                  ...
                                                                  FittedBox(
                                                                    ...
                                                                    child: Container(
                                                                      ...
                                                                      padding: const EdgeInsetsDirectional.only(
                                                                          top: 4.5, bottom: 4.5, start: 4.5, end: 4.5),
                                                                      ...
                                                                      decoration: DesignConfig.boxDecorationContainerBorder(
                                                                          ...
                                                                          orderList[index].activeStatus == deliveredKey
                                                                              ...
                                                                              : orderList[index].activeStatus == cancelledKey
                                                                                  ...
                                                                                  : blueColor.withValues(alpha: 0.10),
                                                                          4.0),
                                                                      child: Text(
                                                                        status,
                                                                        style: TextStyle(
                                                                          fontSize: 12,
                                                                          color: orderList[index].activeStatus == deliveredKey
                                                                              ? Theme.of(context).colorScheme.onPrimary
                                                                              : orderList[index].activeStatus == cancelledKey
                                                                                  ? Theme.of(context).colorScheme.error
                                                                                  : blueColor,
                                                            ...
                                                            Row(
                                                              ...
                                                              children: [
                                                                SvgPicture.asset(DesignConfig.setSvgPath("delivery_time"),
                                                                    colorFilter: const ColorFilter.mode(lightFont, BlendMode.srcIn),
                                            ...
                                            Padding(
                                              padding: EdgeInsetsDirectional.only(
                                                  top: height! / 99.0, bottom: height! / 80.0, start: width! / 40.0, end: width! / 40.0),
                                            ...
                                            Padding(
                                              padding: EdgeInsetsDirectional.only(
                                                  top: height! / 99.0, bottom: height! / 70.0, start: width! / 40.0, end: width! / 40.0),
                                              child: const DashLineView(
                                                fillRate: 0.7,
                                                direction: Axis.horizontal,
                                              ),
                                            ...
                                            Row(
                                              ...
                                              children: [
                                                (orderList[index].activeStatus == preparingKey || orderList[index].activeStatus == cancelledKey)
                                                    ? const SizedBox()
                                                    : (orderList[index].activeStatus == deliveredKey && orderList[index].orderProductRating != "")
                                                        ? Row(mainAxisSize: MainAxisSize.min, mainAxisAlignment: MainAxisAlignment.center, children: [
                                                            ...
                                                            Container(
                                                                ...
                                                                child: Row(children: [
                                                                  Text(
                                                                      "${double.parse(orderList[index].orderProductRating ?? "0.0").toStringAsFixed(2).replaceAll(regex, '')} ",
                                                                      style: TextStyle(
                                                                          color: Theme.of(context).colorScheme.secondary,
                                                                          fontSize: 12,
                                                                          fontWeight: FontWeight.w700)),
                                                        ...
                                                        : SmallButtonContainer(
                                                            ...
                                                            radius: 5.0,
                                                            status: false,
                                                            borderColor: orderList[index].activeStatus == deliveredKey ||
                                                                    (cancelStatus[k] == true &&
                                                                        ((cancelStatusType[k] == "") ||
                                                                            (isStatusAfter(orderList[index].activeStatus!, cancelStatusType[k]))))
                                                ...
                                                orderList[index].activeStatus == outForDeliveryKey
                                                    ? SmallButtonContainer(
                                                        ...
                                                        top: 0,
                                                        radius: 5.0,
                                                        status: (state is ReOrderProgress) ? true : false,
                                                        ...
                                                        onTap: () {
                                                          if (orderList[index].activeStatus == outForDeliveryKey) {
                                                            ...
                                                            Navigator.of(context).pushNamed(Routes.orderTracking, arguments: {
                                                              ...
                                                              'partnerAddress': orderList[index].orderItems![0].partnerDetails![0].partnerAddress!
                                                            });
                                                          } else {}
                                                        },
                                                      )
  ...
  Widget build(BuildContext context) {
    ...
    return AnnotatedRegion<SystemUiOverlayStyle>(
      ...
      child: _connectionStatus == connectivityCheck
          ...
          : Scaffold(
              appBar: DesignConfig.appBar(context, width!, UiUtils.getTranslatedLabel(context, myOrderLabel),
