...
import 'package:project/ui/screen/favourite/favourite_screen.dart';
        ...
        children: [
          Padding(
            ...
            child: ClipRRect(
              ...
              child:
                  image != ""
                      ? DesignConfig.imageWidgets(image, 57, 57, "2")
                      : DesignConfig.imageWidgets('profile_pic', 57, 57, "1"),
            ),
          ),
          Expanded(
            child:
                (context.read<AuthCubit>().state is AuthInitial ||
                    ...
                    ? Column(
                      ...
                      children: [
                        Text(
                          UiUtils.getTranslatedLabel(context, yourProfileLabel),
            ...
            : InkWell(
              ...
              child: Container(
                ...
                child: SvgPicture.asset(
                  DesignConfig.setSvgPath("pro_edit"),
                  width: 14.0,
                  height: 13.99,
                    ...
                    children: [
                      CircleAvatar(
                        ...
                        backgroundColor:
                            Theme.of(context).colorScheme.onSecondary,
                        child: SvgPicture.asset(
                          DesignConfig.setSvgPath("cart_icon"),
                          width: 16.0,
                          height: 16.0,
                          colorFilter: ColorFilter.mode(
                            Theme.of(context).colorScheme.onSurface,
                      ...
                      Text(
                        UiUtils.getTranslatedLabel(context, cartLabel),
                        textAlign: TextAlign.start,
                        style: TextStyle(
                          color: Theme.of(context).colorScheme.onSecondary,
                          fontSize: 12,
                ...
                children: [
                  ...
                  (context.read<AuthCubit>().state is AuthInitial ||
                          ...
                          (context.read<SystemConfigCubit>().getDemoMode() ==
                              "0") ||
                          context.read<AuthCubit>().getMobile() == "9999999999"
                      ? const SizedBox.shrink()
          ...
          _connectionStatus == connectivityCheck
              ...
              : Scaffold(
                appBar: AppBar(
                  ...
                  centerTitle: true,
                  title: Text(
                    UiUtils.getTranslatedLabel(context, accountLabel),
                    textAlign: TextAlign.center,
                    style: const TextStyle(
                      color: white,
                      fontSize: 16,
