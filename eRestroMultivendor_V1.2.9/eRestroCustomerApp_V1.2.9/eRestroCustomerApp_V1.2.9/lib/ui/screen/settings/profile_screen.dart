...
import 'package:project/cubit/profileManagement/updateUserDetailsCubit.dart';
import 'package:project/cubit/profileManagement/uploadProfileCubit.dart';
import 'package:project/data/repositories/profileManagement/profileManagementRepository.dart';
...
//get image file from library
  ...
  void initState() {
    ...
    referralCodeController = TextEditingController(
        text: context.read<AuthCubit>().getReferralCode());
    ...
    return Container(
        ...
        child: TextFormField(
          ...
          decoration: DesignConfig.inputDecorationextField(
              UiUtils.getTranslatedLabel(context, fullNameLabel),
  ...
  Widget referralCodeField() {
    return Container(
        ...
        child: TextFormField(
            ...
            decoration: DesignConfig.inputDecorationextField(
                UiUtils.getTranslatedLabel(context, referralCodeLabel),
                UiUtils.getTranslatedLabel(context, enterReferralCodeLabel),
                width!,
                context),
            keyboardType: TextInputType.text,
            style: const TextStyle(
    ...
    return AnnotatedRegion<SystemUiOverlayStyle>(
      ...
      child: _connectionStatus == connectivityCheck
          ...
          : Scaffold(
              ...
              bottomNavigationBar: BlocConsumer<UpdateUserDetailCubit,
                  ...
                  listener: (context, state) {
                    ...
                    if (state is UpdateUserDetailSuccess) {
                      context
                          .read<AuthCubit>()
                          .updateUserName(state.authModel.username ?? "");
                      context
                          .read<AuthCubit>()
                          .updateUserEmail(state.authModel.email ?? "");
                      context
                          .read<AuthCubit>()
                          .updateUserMobile(state.authModel.mobile ?? "");
                  ...
                  builder: (context, state) {
                    return ButtonContainer(
                      ...
                      width: width,
                      text:
                          UiUtils.getTranslatedLabel(context, saveProfileLabel),
                      start: width! / 40.0,
                      end: width! / 40.0,
                      bottom: height! / 55.0,
                      top: 0,
