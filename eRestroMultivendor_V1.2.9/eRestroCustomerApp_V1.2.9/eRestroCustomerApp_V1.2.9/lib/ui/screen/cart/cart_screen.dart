...
import 'package:project/data/model/cartModel.dart';
...
import 'package:project/data/model/addOnsDataModel.dart';
import 'package:project/data/model/delivery_tip_model.dart';
import 'package:project/data/model/productAddOnsModel.dart';
import 'package:project/data/model/sectionsModel.dart';
import 'package:project/data/model/variantsModel.dart';
...
import 'package:project/ui/styles/dashLine.dart';
...
import 'package:project/ui/screen/offerCoupons/offer_coupons_screen.dart';
import 'package:project/ui/screen/settings/no_internet_screen.dart';
import 'package:project/ui/widgets/simmer/addressSimmer.dart';
import 'package:project/ui/widgets/bottomSheetContainer.dart';
import 'package:project/ui/widgets/simmer/buttonSimmer.dart';
import 'package:project/ui/widgets/simmer/cartSimmer.dart';
                              ...
                              child: Container(
                                ...
                                decoration: deliveryTip == double.parse(deliveryTipList[index].price!)
                                    ? DesignConfig.boxDecorationContainerBorder(
                                        Theme.of(context).colorScheme.primary, Theme.of(context).colorScheme.primary.withValues(alpha: 0.10), 10.0)
                                      ...
                                      if (state is ManageCartSuccess) {
                                        if (context.read<AuthCubit>().state is AuthInitial || context.read<AuthCubit>().state is Unauthenticated) {
                                          ...
                                          context.read<ValidatePromoCodeCubit>().getValidatePromoCode(
                                              ...
                                              walletBalanceUsed.toString(),
                                              context.read<GetCartCubit>().cartPartnerId());
                                        }
                                                        ...
                                                        listener: (context, state) {
                                                          if (state is UpdateAddressSuccess) {
                                                            ...
                                                            if (addressId.isNotEmpty) {
                                                              context.read<DeliveryChargeCubit>().fetchDeliveryCharge(
                                                                  context.read<AuthCubit>().getId(),
                                                                  addressId,
                                                                  context.read<GetCartCubit>().getCartModel().overallAmount.toString());
                                                            }
                                                            ...
                                                            child: Container(
                                                              decoration: addressList[index].isDefault == "1"
                                                                  ? DesignConfig.boxDecorationContainerBorder(Theme.of(context).colorScheme.primary,
                                                                      Theme.of(context).colorScheme.primary.withValues(alpha: 0.10), 15)
                                                                  : DesignConfig.boxDecorationContainerBorder(Theme.of(context).colorScheme.onSurface,
                                                                      Theme.of(context).colorScheme.onSurface, 15),
                                                                                ...
                                                                                Row(
                                                                                    ...
                                                                                    children: [
                                                                                      ...
                                                                                      Expanded(
                                                                                        flex: 2,
                                                                                        child: Text(
                                                                                          "${variantData.cartCount!} x ${offlineCartList[i].name!}",
                ...
                if (state is GetCartSuccess) {
                  ...
                  if (promoCode != "") {
                    context.read<ValidatePromoCodeCubit>().getValidatePromoCode(
                        promoCode,
                        context.read<AuthCubit>().getId(),
                        state.cartModel.overallAmount!.toStringAsFixed(2),
                        walletBalanceUsed.toString(),
                        context.read<GetCartCubit>().cartPartnerId());
                  }
                }
                        ...
                        child: SingleChildScrollView(
                          ...
                          child: Column(
                            ...
                            children: [
                                                ...
                                                if (state is AddressSuccess) {
                                                  ...
                                                  for (int i = 0; i < addressList.length; i++) {
                                                    if (addressList[i].isDefault == "1") {
                                                      context.read<DeliveryChargeCubit>().fetchDeliveryCharge(context.read<AuthCubit>().getId(),
                                                          addressList[i].id!, context.read<GetCartCubit>().getCartModel().overallAmount.toString());
                                                    }
                                                  }
                                                }
                                              },
                                              builder: (context, state) {
                                                ...
                                                if (state is AddressSuccess) {
                                                  ...
                                                  for (int i = 0; i < addressList.length; i++) {
                                                    if (addressList[i].isDefault == "1") {
                                                      context.read<DeliveryChargeCubit>().fetchDeliveryCharge(
                                                          context.read<AuthCubit>().getId(), addressList[i].id!, cartList.overallAmount.toString());
                                                    }
                                                  }
                                                  return Row(children: [
                                                    Text(
                                                    ...
                                                    InkWell(
                                                      ...
                                                      child: Text(
                                                        ...
                                                        style: TextStyle(
                                                            fontSize: 12, color: Theme.of(context).colorScheme.primary, fontWeight: FontWeight.w700),
                                                      ),
                                                    ),
                                                  ]);
                                                }
                                                        ...
                                                        children: [
                                                          cartList.data![i].image!.isEmpty
                                                              ...
                                                              : ClipRRect(
                                                                  ...
                                                                  child: ColorFiltered(
                                                                    colorFilter:
                                                                        cartList.data![i].productDetails![0].partnerDetails![0].isRestroOpen == "1"
                                                                            ? const ColorFilter.mode(
                                                                                Colors.transparent,
                                                                                BlendMode.multiply,
                                                                              )
                                                          ...
                                                          Expanded(
                                                            flex: 3,
                                                            child: Padding(
                                                              padding: EdgeInsetsDirectional.only(start: width! / 50.0, bottom: height! / 99.0),
                                                              child: Column(
                                                                  mainAxisAlignment: MainAxisAlignment.start,
                                                                  crossAxisAlignment: CrossAxisAlignment.start,
                                                                  children: [
                                                                                          ...
                                                                                          Row(children: [
                                                                                            cartList.data![i].productDetails![j].indicator == "1"
                                                                                                ? SvgPicture.asset(
                                                                                                    ...
                                                                                                    width: 15,
                                                                                                    height: 15)
                                                                                                : cartList.data![i].productDetails![j].indicator ==
                                                                                                        "2"
                                                                                                    ? SvgPicture.asset(
                                                                                                        DesignConfig.setSvgPath("non_veg_icon"),
                                                                                                        width: 15,
                                                                                                    ...
                                                                                                    child: Row(
                                                                                                        ...
                                                                                                        children: [
                                                                                                          BlocConsumer<RemoveFromCartCubit,
                                                                                                                  RemoveFromCartState>(
                                                                                                              bloc:
                                                                                                                  context.read<RemoveFromCartCubit>(),
                                                                                                              listener: (context, state) {
                                                                                                                if (state is RemoveFromCartSuccess) {
                                                                                                                  UiUtils.setSnackBar(
                                                                                                                      UiUtils.getTranslatedLabel(
                                    ...
                                    if (value != null) {
                                      setState(() {
                                        ...
                                        context.read<ValidatePromoCodeCubit>().getValidatePromoCode(
                                            promoCode,
                                            context.read<AuthCubit>().getId(),
                                            cartList.overallAmount!.toStringAsFixed(2),
                                            walletBalanceUsed.toString(),
                                            context.read<GetCartCubit>().cartPartnerId());
                                        if (orderTypeIndex.toString() == "0") {
                                ...
                                child: Container(
                                  ...
                                  child: Row(mainAxisAlignment: MainAxisAlignment.center, crossAxisAlignment: CrossAxisAlignment.center, children: [
                                    Text(UiUtils.getTranslatedLabel(context, addCouponLabel),
                                        textAlign: TextAlign.center,
                                        style:
                                            TextStyle(color: Theme.of(context).colorScheme.onSecondary, fontSize: 14, fontWeight: FontWeight.w500)),
                                    const Spacer(),
                                    Text(
                              ...
                              promoCode != ""
                                  ? Padding(
                                      padding: EdgeInsetsDirectional.only(top: height! / 70.0, start: width! / 40.0, bottom: 5.0, end: width! / 40.0),
                                      child: Row(
                                        children: [
                                              ...
                                              return Row(
                                                children: [
                                                  ...
                                                  Text(
                                                      ...
                                                      textAlign: TextAlign.start,
                                                      style: TextStyle(
                                                          color: Theme.of(context).colorScheme.onPrimary, fontSize: 12, fontWeight: FontWeight.w700))
                                                ],
                                              );
                                            } else {
                                              return const SizedBox();
                              ...
                              Container(
                                width: width!,
                                padding:
                                    EdgeInsetsDirectional.only(start: width! / 35.0, top: height! / 80.0, end: width! / 35.0, bottom: height! / 80.0),
                              ...
                              Container(
                                  ...
                                  child: Column(mainAxisAlignment: MainAxisAlignment.start, crossAxisAlignment: CrossAxisAlignment.start, children: [
                                    Text(UiUtils.getTranslatedLabel(context, billDetailLabel),
                                        textAlign: TextAlign.start,
                                        style:
                                            TextStyle(color: Theme.of(context).colorScheme.onSecondary, fontSize: 15, fontWeight: FontWeight.w700)),
                                    Padding(
                                      padding: const EdgeInsetsDirectional.only(
                                        top: 4.5,
                                        bottom: 4.5,
                                    ...
                                    Row(children: [
                                      ...
                                      Text(context.read<SystemConfigCubit>().getCurrency() + (subTotal).toStringAsFixed(2),
                                          textAlign: TextAlign.end,
                                          style: TextStyle(color: Theme.of(context).colorScheme.onSecondary, fontSize: 15, letterSpacing: 0.8)),
                                    ]),
                                    Padding(
                                      padding: const EdgeInsetsDirectional.only(
                                        top: 4.5,
                                                        ...
                                                        children: [
                                                            ...
                                                            children: [
                                                              ...
                                                              context.read<SystemConfigCubit>().isFirstOrder() == "1"
                                                                  ? Text(
                                                                      ...
                                                                      textAlign: TextAlign.left,
                                                                      style:
                                                                          TextStyle(color: Theme.of(context).colorScheme.onSecondary, fontSize: 11))
                                                                  : const SizedBox.shrink(),
                                                            ],
                                                          ),
                                                          const Spacer(),
                                                          Text("${context.read<SystemConfigCubit>().getCurrency()}${state.deliveryCharge.toString()}",
                                                              ...
                                                              style: TextStyle(
                                                                color: Theme.of(context).colorScheme.primary,
                                                                decoration:
                                                                    state.isFreeDelivery == "1" ? TextDecoration.lineThrough : TextDecoration.none,
                                                                fontSize: 12,
                                                              )),
                                                          Text(
        ...
        child: _connectionStatus == connectivityCheck
            ...
            : Scaffold(
                                              ...
                                              listener: (context, state) {
                                                if (state is GetCartSuccess) {
                                                  for (int i = 0; i < addressList.length; i++) {
                                                    if (addressList[i].isDefault == "1") {
                                                      context.read<DeliveryChargeCubit>().fetchDeliveryCharge(context.read<AuthCubit>().getId(),
                                                          addressList[i].id!, state.cartModel.overallAmount.toString());
                                                    }
                                                  }
                                                }
                                                if (state is GetCartFailure) {
                ...
                body: RefreshIndicator(
                  ...
                  color: Theme.of(context).colorScheme.primary,
                  child: Container(margin: EdgeInsetsDirectional.only(top: height! / 99.0), width: width, height: height!, child: cartData()),
                ),
              ));
  }
}
