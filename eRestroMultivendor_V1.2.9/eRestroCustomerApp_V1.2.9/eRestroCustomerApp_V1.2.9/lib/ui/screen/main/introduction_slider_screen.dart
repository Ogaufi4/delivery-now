...
import 'package:project/data/model/introduction_slider_model.dart';
...
class IntroductionSliderScreenState extends State<IntroductionSliderScreen>
  ...
  void initState() {
    ...
    timer = Timer.periodic(const Duration(seconds: 5), (Timer timer) {
      ...
      if (nextPage >= introductionSliderList.length) {
        nextPage = 0;
      }
  ...
  _onPageChanged(int index) {
    setState(() {
      currentIndex = index;
      endProgress = currentIndex / (introductionSliderList.length - 1);
      if (endProgress == 0.0) {
        endProgress = 0.05;
      }
                ...
                child: Column(
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        introductionSliderList[index].title!,
                        style: TextStyle(
                            fontSize: 22,
                    ...
                    Padding(
                      ...
                      child: Text(
                        introductionSliderList[index].subTitle!,
                        textAlign: TextAlign.center,
                ...
                child: Stack(
                  children: <Widget>[
                    ...
                    Container(
                      alignment: Alignment.center,
                      margin: EdgeInsetsDirectional.only(
                          bottom: height! / 99, top: height! / 1.5),
                      child: Stack(
                        alignment: Alignment.center,
                        children: [
                          SizedBox(
                            ...
                            child: TweenAnimationBuilder<double>(
                                tween:
                                    Tween<double>(begin: 0.0, end: endProgress),
